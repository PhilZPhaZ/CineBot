...
class Person(TMDb):
    ...
    def get_infos_from_the_person(self, person_id, append_to_response=""):
        """
        ...
        return self._request_obj(
            self._urls_person["details"] % person_id,
    ...
    def changes(self, person_id, start_date=None, end_date=None, page=1):
        ...
        return self._request_obj(
            self._urls_person["changes"] % person_id,
            params=params,
            key="changes"
        )
    ...
    def movie_credits(self, person_id):
        ...
        :return:
        """
        return self._request_obj(self._urls_person["movie_credits"] % person_id)
    ...
    def tv_credits(self, person_id):
        ...
        :return:
        """
        return self._request_obj(self._urls_person["tv_credits"] % person_id)

    def combined_credits_person(self, person_id):
        """
        Get the movie and TV credits together in a single response.
        :param person_id: int
        :return:
        """
        return self._request_obj(self._urls_person["combined_credits"] % person_id)
    ...
    def external_ids(self, person_id):
        ...
        :return:
        """
        return self._request_obj(self._urls_person["external_ids"] % person_id)

    def images_person(self, person_id):
        """
        ...
        """
        return self._request_obj(
            self._urls_person["images"] % person_id,
            key="profiles"
        )
    ...
    def tagged_images(self, person_id, page=1):
        ...
        """
        return self._request_obj(
            self._urls_person["tagged_images"] % person_id,
            params="page=%s" % page,
            key="results"
        )
    ...
    def translations(self, person_id):
        ...
        """
        return self._request_obj(
            self._urls_person["translations"] % person_id,
            key="translations"
        )
    ...
    def latest(self):
        ...
        :return:
        """
        return self._request_obj(self._urls_person["latest"])
    ...
    def popular(self, page=1):
        ...
        """
        return self._request_obj(
            self._urls_person["popular"],
            params="page=%s" % page,
            key="results"
        )

    def get_person_infos(self, term, page=1):
        """
        Search for people.
        :param term: string
        :param page: int
