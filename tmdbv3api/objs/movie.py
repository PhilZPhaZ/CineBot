...
class Movie(TMDb):
    _urls_movie = {
        ...
        "combined_credits_person": "/person/%s/combined_credits",
    }

    def details_film(self, movie_id, append_to_response="videos,trailers,images,casts,translations,keywords,release_dates"):
        """
        ...
        return self._request_obj(
            self._urls_movie["details"] % movie_id,
    ...
    def account_states(self, movie_id):
        ...
        """
        return self._request_obj(
            self._urls_movie["account_states"] % movie_id,
    ...
    def alternative_titles(self, movie_id, country=None):
        ...
        """
        return self._request_obj(
            self._urls_movie["alternative_titles"] % movie_id,
    ...
    def changes(self, movie_id, start_date=None, end_date=None, page=1):
        ...
        return self._request_obj(
            self._urls_movie["changes"] % movie_id,
            params=params,
            key="changes"
        )
    ...
    def credits(self, movie_id):
        ...
        :return:
        """
        return self._request_obj(self._urls_movie["credits"] % movie_id)
    ...
    def external_ids(self, movie_id):
        ...
        :return:
        """
        return self._request_obj(self._urls_movie["external_ids"] % movie_id)
    ...
    def images(self, movie_id, include_image_language=None):
        ...
        """
        return self._request_obj(
            self._urls_movie["images"] % movie_id,
    ...
    def keywords(self, movie_id):
        ...
        """
        return self._request_obj(
            self._urls_movie["keywords"] % movie_id,
            key="keywords"
        )
    ...
    def lists(self, movie_id, page=1):
        ...
        """
        return self._request_obj(
            self._urls_movie["lists"] % movie_id,
            params="page=%s" % page,
            key="results"
        )
    ...
    def recommendations(self, movie_id, page=1):
        ...
        """
        return self._request_obj(
            self._urls_movie["recommendations"] % movie_id,
            params="page=%s" % page,
            key="results"
        )
    ...
    def release_dates(self, movie_id):
        ...
        """
        return self._request_obj(
            self._urls_movie["release_dates"] % movie_id,
            key="results"
        )
    ...
    def reviews(self, movie_id, page=1):
        ...
        """
        return self._request_obj(
            self._urls_movie["reviews"] % movie_id,
            params="page=%s" % page,
            key="results"
        )
    ...
    def similar(self, movie_id, page=1):
        ...
        """
        return self._request_obj(
            self._urls_movie["similar"] % movie_id,
            params="page=%s" % page,
            key="results"
        )
    ...
    def translations(self, movie_id):
        ...
        """
        return self._request_obj(
            self._urls_movie["translations"] % movie_id,
            key="translations"
        )
    ...
    def videos(self, movie_id, page=1):
        ...
        """
        return self._request_obj(
            self._urls_movie["videos"] % movie_id,
            params="page=%s" % page,
            key="results"
        )

    def watch_providers_movie(self, movie_id):
        """
        ...
        """
        return self._request_obj(
            self._urls_movie["watch_providers"] % movie_id,
            key="results"
        )
    ...
    def rate_movie(self, movie_id, rating):
        ...
        """
        self._request_obj(
            self._urls_movie["rate_movie"] % movie_id,
            params="session_id=%s" % self.session_id,
            method="POST",
            json={"value": rating}
        )
    ...
    def delete_rating(self, movie_id):
        ...
        """
        self._request_obj(
            self._urls_movie["delete_rating"] % movie_id,
            params="session_id=%s" % self.session_id,
            method="DELETE"
        )
    ...
    def latest(self):
        ...
        :return:
        """
        return self._request_obj(self._urls_movie["latest"])
    ...
    def upcoming(self, region=None, page=1):
        ...
        if region:
            params += "&region=%s" % region
        return self._request_obj(
            self._urls_movie["upcoming"],
            params=params,
            key="results"
        )

    def get_movie_infos(self, term, page=1):
        """
        Search for movies.
        :param term: str
        :param page: int
